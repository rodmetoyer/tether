...
for i=1:1:N
    ...
    cjX = [0 0 0; 0 0 -thr.link(i).c; 0 thr.link(i).c 0;];
    ...
    if i == 1
        ...
        rjXprevious = [0 0 0; 0 0 -thr.link(i-1).x; 0 thr.link(i-1).x 0;];
    ...
    if i < N
        SR(3*i-2:3*i,3*i+1:3*i+3) = cjX; % Adds rjX to diagonal edge of the upper triangle - everything else is 0
